...
func (x *Response) GetGoods() string {
	if x != nil {
		return x.Goods
	}
	return ""
...
var file_proto_order_order_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x1b, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x10, 0x0a, 0x03,
	0x73, 0x61, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x61, 0x79, 0x22, 0x19,
	0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x34, 0x0a, 0x08, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x67, 0x6f, 0x6f,
	0x64, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x22,
	...
	0x73, 0x74, 0x72, 0x6f, 0x6b, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x74,
	0x72, 0x6f, 0x6b, 0x65, 0x32, 0x85, 0x02, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x4b,
	0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x1f, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72,
	...
	0x63, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69,
	...
	0x64, 0x65, 0x72, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x1a, 0x1c, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69,
	0x63, 0x72, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x2e, 0x50, 0x6f, 0x6e, 0x67, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_order_order_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: go.micro.service.order.Message
	(*Request)(nil),           // 1: go.micro.service.order.Request
	(*Response)(nil),          // 2: go.micro.service.order.Response
	(*StreamingRequest)(nil),  // 3: go.micro.service.order.StreamingRequest
	(*StreamingResponse)(nil), // 4: go.micro.service.order.StreamingResponse
	(*Ping)(nil),              // 5: go.micro.service.order.Ping
	(*Pong)(nil),              // 6: go.micro.service.order.Pong
}
var file_proto_order_order_proto_depIdxs = []int32{
	1, // 0: go.micro.service.order.Order.Call:input_type -> go.micro.service.order.Request
	3, // 1: go.micro.service.order.Order.Stream:input_type -> go.micro.service.order.StreamingRequest
	5, // 2: go.micro.service.order.Order.PingPong:input_type -> go.micro.service.order.Ping
	2, // 3: go.micro.service.order.Order.Call:output_type -> go.micro.service.order.Response
	4, // 4: go.micro.service.order.Order.Stream:output_type -> go.micro.service.order.StreamingResponse
	6, // 5: go.micro.service.order.Order.PingPong:output_type -> go.micro.service.order.Pong
